...
const Test: FC = () => {
  ...
  return (
    ...
    >
      <div
        className='relative w-[300vw] grid place-content-start grid-cols-3'
        data-scroll
        data-scroll-direction='horizontal'
        data-scroll-speed='10'
        ref={sectionRef}
      >
        <div className='p-4 w-[100vw] text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700'>
